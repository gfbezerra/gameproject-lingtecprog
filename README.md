...
No jogo fuga da prisão, o jogador tem como missão escapar de uma prisão representada por um labirinto. Para conseguir fugir, o jogador deverá explorar o mapa em busca das chaves necessárias para abrir a porta da prisão, enquanto evita os guardas responsáveis por patrulhar o local. Caso o jogador seja encontrado por um guarda ou atinja o nível máximo de suspeita, a partida será encerrada com derrota.             
...
Seja agil e fuja antes que eles te pegem! 
